  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 mb-6">
        <StatCard label="Total Users" value={stats.totalUsers} icon={Users} iconColor="bg-primary-50 text-primary-600" />
        <StatCard label="Active Technicians" value={stats.activeTechs} icon={Wrench} iconColor="bg-emerald-50 text-emerald-600" />
        <StatCard label="Today's Work Orders" value={stats.todayWOs} icon={ClipboardList} iconColor="bg-blue-50 text-blue-600" />
        <StatCard label="Total Documents" value={stats.pendingDocs} icon={FolderOpen} iconColor="bg-amber-50 text-amber-600" />
        <StatCard label="Completed Jobs" value={stats.completed} icon={CheckCircle2} iconColor="bg-teal-50 text-teal-600" />
        <StatCard label="Open Incidents" value={stats.openIncidents} icon={AlertTriangle} iconColor="bg-red-50 text-red-600" />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <Card className="lg:col-span-2">
          <SectionHeader
            ...
            subtitle="Last 7 months · all service types"
        ...
        <Card>
          ...
          <DonutChart
            ...
            centerLabel={String(totalWOsThisQuarter)} centerSub="Total WOs"
          />
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <Card>
          <SectionHeader title="Technician Performance" subtitle="Completed jobs" />
          <HorizontalBars
        ...
        <Card className="lg:col-span-2">
          ...
          <div className="space-y-1">
            {activities.length === 0 && <p className="text-sm text-ink-400 py-4 text-center">No recent activity yet</p>}
            {activities.map((a) => (
